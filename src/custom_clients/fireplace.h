...
namespace SEFL
{
	...
	public:
		...
		uint8_t getLiquidLevelLed() const;
		void setLiquidLevelLed(uint8_t liquidLevelLed);
		uint8_t getLiquidLevelSensor() const;
