...
namespace SEFL
{
	...
	bool Quest_Client::isChangedStatus() const
	{
	...
	SEFL::Language Quest_Client::getLanguage() const
	{
		return (language_);
	}
	...
	const char *Quest_Client::getName() const
	{
		return (name_);
	}

	bool Quest_Client::isPowerStatus() const
	{
	...
	ClientType Quest_Client::getType() const
	{
		return (type_);
	}
