...
namespace SEFL
{
	...
	class LEDMatrixPuzzleNeopixel : public Quest_Basic_Client
	{
	...
	public:
		explicit LEDMatrixPuzzleNeopixel(MQTTClient &mqtt, const char *name = DEFAULT_DEVICE_NAME,
		...
		~LEDMatrixPuzzleNeopixel() override;
		// user defined
