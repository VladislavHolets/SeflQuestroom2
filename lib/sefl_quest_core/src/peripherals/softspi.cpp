...
void SOFTSPI::begin(unsigned char csnPin, unsigned char sckPin, unsigned char mosiPin, unsigned char misoPin)
{
...
void SOFTSPI::writeByte(unsigned char dat)
{
  unsigned char i;
  for (i = 0; i < 8; i++)
  {
...
unsigned char SOFTSPI::readByte(void)
{
