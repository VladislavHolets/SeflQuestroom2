...
void RFID1::begin(unsigned char csnPin, unsigned char sckPin, unsigned char mosiPin, unsigned char misoPin, unsigned char chipSelectPin, unsigned char NRSTPD)
{
 ...
 * Return：Null
 **********************************************************/
void RFID1::showCardID(unsigned char *id)
{
    int IDlen = 4;
    for (int i = 0; i < IDlen; i++)
    {
        SEFL::Logger::notice("rfid", 0x0F & (id[i] >> 4), HEX);
        SEFL::Logger::notice("rfid", 0x0F & id[i], HEX);
    }
    // Serial.println();
    // Serial.println();
}
 ...
 * Return：Null
 **********************************************************/
void RFID1::showCardType(unsigned char *type)
{
    SEFL::Logger::notice("rfid", "Card type: ");
    if (type[0] == 0x04 && type[1] == 0x00)
        SEFL::Logger::notice("rfid", "MFOne-S50");
    else if (type[0] == 0x02 && type[1] == 0x00)
        SEFL::Logger::notice("rfid", "MFOne-S70");
    else if (type[0] == 0x44 && type[1] == 0x00)
        SEFL::Logger::notice("rfid", "MF-UltraLight");
    else if (type[0] == 0x08 && type[1] == 0x00)
        SEFL::Logger::notice("rfid", "MF-Pro");
    else if (type[0] == 0x44 && type[1] == 0x03)
        SEFL::Logger::notice("rfid", "MF Desire");
    else
        SEFL::Logger::notice("rfid", "Unknown");
}
/**********************************************************
 ...
 * Return：Null
 **********************************************************/
void RFID1::writeTo(unsigned char addr, unsigned char val)
{
 ...
 **********************************************************/
unsigned char RFID1::readFrom(unsigned char addr)
{
    unsigned char val;
 ...
 * Return：null
 **********************************************************/
void RFID1::setBitMask(unsigned char reg, unsigned char mask)
{
    unsigned char tmp;
    tmp = readFrom(reg);
 ...
 * Return：null
 **********************************************************/
void RFID1::clearBitMask(unsigned char reg, unsigned char mask)
{
    unsigned char tmp;
    tmp = readFrom(reg);
 ...
 */
unsigned char RFID1::request(unsigned char reqMode, unsigned char *TagType)
{
 ...
 * return：return MI_OK if successed
 */
unsigned char RFID1::toCard(unsigned char command, unsigned char *sendData, unsigned char sendLen, unsigned char *backData, unsigned int *backLen)
{
 ...
 * return：return MI_OK if successed
 */
unsigned char RFID1::anticoll(unsigned char *serNum)
{
    unsigned char status;
    unsigned char i;
 ...
 * return：Null
 */
void RFID1::calulateCRC(unsigned char *pIndata, unsigned char len, unsigned char *pOutData)
{
    unsigned char i, n;
 ...
 * return：return MI_OK if successed
 */
unsigned char RFID1::write(unsigned char blockAddr, unsigned char *writeData)
{
    unsigned char status;
