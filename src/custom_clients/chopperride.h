...
namespace SEFL
{
	...
	public:
		...
		uint8_t getChopperLeftButton() const;
		...
		uint8_t getChopperRightButton() const;
		...
		uint8_t getChopperThrottle() const;
		void setChopperThrottle(uint8_t chopperThrottle);
		uint8_t getContactMagnet() const;
		...
		uint64_t getTimerThrottle() const;
